...
// Post performs a POST request to baseURL+path with a Bearer authorization header
// and Content-Type: application/json. The caller is responsible for closing the response body.
